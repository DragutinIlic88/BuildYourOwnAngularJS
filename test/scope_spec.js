  ...
  describe("Scope",function(){
    ...
    describe("digest", function(){
        ...
        it("triggers chained watchers in the same digest", function(){
            ...
            //watches nameUpper and assigns initial
            scope.$watch(
            ...
            //watches name and assignes nameUpper
            scope.$watch(
        ...
        it("has a $$phase field whose value is the current digest phase", function(){
            ...
            //calling $apply call $digest implicitly
            scope.$apply(function(scope){
        ...
        it("schedules a digest in $evalAsync", function(done){
            ...
            expect(scope.counter).toBe(0);
            //for checking that digest is indeed run slightly after $evalAsync call
            setTimeout(function(){
                expect(scope.counter).toBe(1);
                //to setTimeout work with Jasmine we use it asynchronous test support
                //we call done argument so that test case function finish execution
                done();
            }, 50);
        });

        //this test is same as evalAsync
        ...
        it("cahtches exceptions in watch functions and continues", function(){
            scope.aValue = 'abc';
            scope.counter = 0;
        ...
        it("cathces exceptions in $applyAsync", function(done){
            scope.$applyAsync(function(scope){
                throw "Error";
            });
        ...
        describe("inheritance", function(){
            ...
            it("can watch property in the parent", function(){
                var parent = new Scope();
                var child = parent.$new();
                parent.aValue = [1,2,3];
                child.counter = 0;
            ...
            it("digest from root no $apply", function(){
                var parent =  new Scope();
                var child = parent.$new();
                var child2 = parent.$new();
    ...
    describe("Events", function(){
        ...
        _.forEach(['$emit','$broadcast'], function(method){
            it("calls listeners registered for matching events on "+ method, function(){
                //special stub functions that record whether they have been called
                //or not, and what arguments they've been called with
            ...
            it("passes an event object with a name to listeners on " + method, function(){
                ...
                //calls.mostRecent() function of Jasmine spy contains information about
                //the last time that spy was called. args attribute contains array of
            ...
            it("does not stop on expections on "+ method, function(){
        ...
        it("sets current scope on null after propagation on $emit", function(){
            var event;
        ...
        it("sets current scope on null after propagation on $broadcast", function(){
            var event;
            var scopeListener = function(evt){
                event = evt;
            };
        ...
        it("does not propagate to parents when stopped", function(){
            ...
            scope.$on('someEvent', stopListener);
            parent.$on('someEvent', parentListener);
